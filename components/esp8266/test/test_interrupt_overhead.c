...
#  define INTERRUPT_OVERHEAD_ENTER_TIME 328
#  define INTERRUPT_OVERHEAD_TOTAL_TIME 443
#else // CONFIG_OPTIMIZATION_LEVEL_RELEASE
#  define INTERRUPT_OVERHEAD_ENTER_TIME 252
#  define INTERRUPT_OVERHEAD_TOTAL_TIME 369
#endif
