This is a simple multi-threading example using freeRTOS framework.

Two tasks are created and perform the following operations in parallel:
1. Toggle GPIO
2. Print keep-alive prompts on UART0.

HOWTO:
1. Copy this folder to anywhere.
Example:
   Copy to ~/workspace/multi_thread_blinky
